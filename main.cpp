...
int main(int argc, char *argv[])
{
    ...
    QCommandLineOption alteriso_2("alteriso2","enable alteriso 2");
    ...
    parser.addOptions({alteriso_2,alteriso_proj_path});
    parser.process(a);
    main_mainwindow_interface m_interface;
    m_interface.set_alteriso3(!parser.isSet(alteriso_2));
